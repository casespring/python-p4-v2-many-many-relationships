...
class Employee(db.Model):
    ...
    # Relationship mapping the employee to related assigments
...
class Project(db.Model):
    ...
    # Relationship mapping the project to related assingments
...
class Assignment(db.Model):
    ...
    # Relationship mappeing the assignment to related employee
